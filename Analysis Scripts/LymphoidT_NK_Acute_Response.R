...
# Lymphoid T Lineage #
lympho_tmp = subset(endo, idents = c("CD4 Naive", "CD8 Naive", "CD4 Mem", "CD8 Mem", "NK",
                                     "Inflam CD4 Naive", "Inflam CD8 Naive", "Inflam NK"))
...
saveRDS(lympho, "LymphoidT_D0_4h_NoBatchCorrect.rds")
...
saveRDS(lympho_mnn, "LymphoidT_D0_4h_MNN.rds")